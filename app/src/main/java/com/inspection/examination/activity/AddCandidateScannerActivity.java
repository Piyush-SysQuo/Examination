...
import com.inspection.examination.model.GetCandidateDataForAnyCentreResponse.CandidateData;
...
import com.inspection.examination.viewmodel.GetCandidateDataForAnyCentreViewModel;
import com.inspection.examination.viewmodel.GetCandidateDataViewModel;
import com.inspection.examination.viewmodel.UpdateCandidateCentreViewModel;
...
//                    Boolean status = updateOccurrenceAPIResponse.getStatus();
                    if (updateCandidateCentreAPIResponse.getStatus()){
                        com.inspection.examination.model.UpdateCandidateCentreResponse.CandidateData candData = updateCandidateCentreAPIResponse.getData().getCandidateData();
...
//        Toast.makeText(this, "Candidate Added to centre successfully!", Toast.LENGTH_SHORT).show();
        ...
        com.inspection.examination.model.GetCandidateDataResponse.CandidateData candidateData = new com.inspection.examination.model.GetCandidateDataResponse.CandidateData(
